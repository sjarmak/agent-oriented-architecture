...
if (missing.length) {
  console.log(`::error::Architecture model has ${missing.length} dead source link(s) — the model has drifted from the code; failing so the stale model is not published (fix in architecture/*.c4):`);
